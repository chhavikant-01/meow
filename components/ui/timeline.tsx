          ...
          {data.map((item, index) => (
            <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
              ...
              <div className="relative pl-20 pr-4 md:pl-4 w-full">
                <h3 className="md:hidden block text-xl mb-4 text-left font-bold text-gray-100 dark:text-gray-200">
                  {item.title}
                </h3>
                <div className="text-sm md:text-base text-gray-100 dark:text-gray-200">
                  {item.content}
                </div>
              </div>
            </div>
